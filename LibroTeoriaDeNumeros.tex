...
% =======================================================
    ...
    \def\ProjectNameLink{\ProjectAuthorLink/LibroTeoriaDeNumeros}    
...
\begin{titlepage}
    ...
    {\fontsize{45}{55}\selectfont \textbf{Teoría de Números}}\\[0.5cm] %Name of the book
...
\chapter{Divisibilidad}
    ...
    \section{Divisibilidad}
        ...
        % ==================================
        \clearpage
        \subsection{Ejemplo sobre que es Divisibilidad}
        ...
        \subsection*{Definición Alterna}
            ...
            \begin{SmallIndentation}[2em]
                ...
                \begin{MultiLineEquation*}{3}
                    GCD(5, 15) 
                        &= 2^{min(0,0)}         \cdot 3^{min(0,1)}
                            \cdot 5^{min(1,1)}  \cdot 7^{min(0,0)}
                            \cdot 11^{min(0,0)} \cdot 13^{min(0,0)}     \\
                        &= 2^0         \cdot 3^0
                            \cdot 5^1  \cdot 7^0
                            \cdot 11^0 \cdot 13^0                       
                            = 5^1 = 5
            ...
            \begin{itemize}
                ...
                \item $GCD(ka, kb) = |k|GCD(a,b)$
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        Usando la idea de que el mínimo común multiplo se puede expresar como 
                        la mínima combinación lineal podemos decir que:

                        \begin{MultiLineEquation}{2}
                            GCD(ka, kb)
                                &= m(ka) + n(kb)    \Remember{Recuerda que es la mínima combinación}    \\
                                &= |k|(am+bn)       \Remember{Recuerda que es la mínima combinación}    \\
                                &= |k|GCD(a+b)      \Remember{Magia}
                        \end{MultiLineEquation}
    ...
    \section{Algorítmo de Euclides}
        ...
        % =======================================
        % ==   EL AGORITMO Y LOS IRRACIONALES  ==
        % =======================================
        \clearpage
            ...
            \begin{itemize}
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        \begin{MultiLineEquation*}{3}
                            \sum_{d | p^k} \phi(d)
                                ...
                                &= 1 + (p-1) + p^2(1 - \dfrac{1}{p}) + \dots +  p^k(1 - \dfrac{1}{p})       \\
                                &= p + (1 - \dfrac{1}{p})[p^2 + p^3 + \dots + p^k]                          \\
                                &= p + (1 - \dfrac{1}{p}) \pfrac{p^2 - p^{k+1}}{1-p}                        \\
                                &= p + \pfrac{p-1}{p} \pfrac{p^2 - p^{k+1}}{1-p}                            \\
                                &= p - \pfrac{p^2 - p^{k+1}}{p}                                             \\
                                &= p - (p - p^k)                                                            \\
                                &= p^k          
                        \end{MultiLineEquation*}
                        ...
                        Ahora por inducción podemos resolver el caso en que $n = p_1^{k_1} p_2^{k_2} \dots p_r^{k_r}$

                        Ahora apliquemos inducción sobre el número de primos que dividen a $n$ y todo estará listo con 
                        un par de pasos extra.
                ...
                \item Esta función es multiplicativa, es decir:
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        Ahora, supon que $(m, n) > 1$, es decir, no son primos relativos, es decir comparten
                        mínimo un número en su factorización prima.

                        Ahora podemos entonces decir que entonces podemos decir que $n = GCD(n, m)k$, ahora sabemos 
                        que $\phi(m, n) = \phi(\frac{GCD(m, n)}{GCD(n, m)}n m) = \phi(m) \phi(\frac{n}{GCD(m, n)})
                        = \phi(m) \phi(n) \frac{GCD(m, n)}{\phi(GCD(m, n))}$
                        ...
                        \begin{MultiLineEquation*}{3}
                            \phi(n) 
                                &= \phi\Wrap{p_1^{e_1}p_2^{e_2} \dots p_r^{e_r}}
                                    &&\Space\text{Usando la factorización prima}            \\
                                &= \phi\Wrap{p_1^{e_1}}\dots \phi \Wrap{p_r^{e_r}}
                                    &&\Space\text{Usando que es una fn multiplicativa}      \\
                                &= p_1^{e_1} \Wrap{1 - \dfrac{1}{p_1}}
                                   \dots
                                   p_r^{e_r} \Wrap{1 - \dfrac{1}{p_r}}
                                    &&\Space\text{Usando la propiedad de arriba}            \\
                                &= p_1^{e_1} \dots p_r^{e_r}
                                    \Wrap{1 - \dfrac{1}{p_1}} \dots \Wrap{1 - \dfrac{1}{p_r}}
                                    &&\Space\text{Reordenamos}                              \\
                                &= n
                                    \prod_{p|n} \Wrap{1 - \dfrac{1}{p}}
                                    &&\Space\text{Finalmente}                               \\
                        \end{MultiLineEquation*}
...
\chapter{Congruencias}
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        \begin{MultiLineEquation*}{3}
                            (a+b)^n
                                ...
                                &= \sum_{k=0}^n \dfrac{p!}{k!(n-k)!} a^{n-k}b^k
                        \end{MultiLineEquation*}
        ...
        \subsection{La Aritmética en Congruncias}
            ...
            \begin{itemize}
                ...
                \item 
                    ...
                    Ahora, supongamos que estamos seguros de que existe $a^{-1}$, entonces ... ¿Cómo
                    lo encontramos?

                    \begin{itemize}
                        \item 
                            Podemos ver que el pequeño teorema de Fermat, ya sabes el que dice que:
                            \Quote{Si $(a, m) = 1$ entonces $a^{\phi(n)} \equiv 1 \pmod{n}$}.
                        ...
                        \item
                            Por otro lado podemos usar Teorema de Euclides Extendido, te explico como:
                            
                            \begin{itemize}

                                \item Hagamos el algoritmo de Euclides extendido entre (a, n), entonces
                                    llegaremos a obtener que $a(x) + n(y) = gcd(a, n)$.

                                \item
                                    Ahora, como sabemos que el inverso existe entonces podemos hacer esto:
                                    \begin{MultiLineEquation*}{3}
                                        a(x) + n(y) &= gcd(a, n)            \\
                                        a(x) + n(y) &= 1                    \\
                                        a(x) + n(y) &\equiv 1 \pmod{n}      \\
                                        a(x) + 0 &\equiv 1 \pmod{n}         \\
                                        a(x) &\equiv 1 \pmod{n}             \\
    ...
    \section{Propiedades y Teoremas Importantes}
        ...
        % =====================================================
        % =====  TEOREMA DE GENERALIZADO DE EULER    ==========
        % =====================================================
        ...
        \subsection{Pequeño Teorema de Fermat}
            ...
            Llamamos al Teorema anterior \Quote{Teorema Generalizado de Fermat por Euler}
            porque generaliza un Teorema conocido como el pequeño Teorema de Fermat.

            Este se enuncia como que si $a, n \in \Integers$ donde $p$ no divida a $a$
            tenemos entonces que:
            \begin{MultiLineEquation*}{3}
                p       &\;|\;    && n^p - n           \Space &&\text{Versión con Divisibilidad} \\
                a^{p-1} &\equiv \;&& 1 \pmod{p}        \Space &&\text{Versión con Congruencias}
            \end{MultiLineEquation*}
            ...
            \begin{SmallIndentation}[1em]
                ...
                Ahora, sabemos que si $n$ es un primo, tenemos que
                $a^{\phi(p)} \equiv 1 \pmod{p}$, pero ya también sabemos que como
                $p$ es un primo $\phi(p) = p - 1$, por lo tanto $a^{p-1} \equiv 1 \pmod{p}$.

                Que es una de las versiones del teorema, para llegar a la otro tenemos que 
                multiplicar todo por $a$, así tenemos que $a^p \equiv a \pmod{p}$.

                Recuerda la definición formal de las congruencias, por lo que tenemos que
                $p |a^p - a$, y cambiando un el nombre de una variable llegamos a que
                $p |n^p - n$.
                ...
                \begin{SmallIndentation}[1em]
                    ...
                    \begin{itemize}
                        \item Encontremos a $c_1$
                            \begin{MultiLineEquation*}{3}
                                c_1 (4)(5)                  &\equiv 1 &&\pmod{3}    \\
                                c_1 (20)                    &\equiv 1 &&\pmod{3}    \\
                                c_1 (2)                     &\equiv 1 &&\pmod{3}    \\
                                c_1                         &\equiv 2 &&\pmod{3}   
                            \end{MultiLineEquation*}

                        \item Encontremos a $c_2$
                            \begin{MultiLineEquation*}{3}
                                c_2 (3)(5)                  &\equiv 1 &&\pmod{4}    \\
                                c_2 (15)                    &\equiv 1 &&\pmod{4}    \\
                                c_2 (3)                     &\equiv 1 &&\pmod{4}    \\
                                c_2                         &\equiv 3 &&\pmod{4}    
                            \end{MultiLineEquation*}
                        ...
                        \item Encontremos a $c_3$
                            \begin{MultiLineEquation*}{3}
                                c_3 (3)(4)                  &\equiv 1 &&\pmod{5}    \\
                                c_3 (12)                    &\equiv 1 &&\pmod{5}    \\
                                c_3 (2)                     &\equiv 1 &&\pmod{5}    \\
                                c_3                         &\equiv 3 &&\pmod{5}        
                            \end{MultiLineEquation*}
                ...
                \begin{SmallIndentation}[1em]
                    ...
                    \begin{MultiLineEquation*}{3}
                        (p-1)!
                            ...
                            \Brackets{(\frac{p-1}{2})(p-\frac{p-1}{2})} &&\pmod{p}    \\
                            &\equiv \prod_{i=2}^{\frac{p-1}{2}} i (p-i) &&\pmod{p}    \\
                            &\equiv \prod_{i=2}^{\frac{p-1}{2}} ip-i^2  &&\pmod{p}    \\
                            &\equiv \prod_{i=2}^{\frac{p-1}{2}} 0 -i^2  &&\pmod{p}    \\
                            &\equiv \prod_{i=2}^{\frac{p-1}{2}}   -i^2  &&\pmod{p}    \\
                            &\equiv (-1)^{\frac{p-1}{2}}
                                \prod_{i=2}^{\frac{p-1}{2}}    i^2      &&\pmod{p}    \\
                            &\equiv (-1)^{\frac{p-1}{2}}
                                \Wrap{\prod_{i=2}^{\frac{p-1}{2}} i}^2  &&\pmod{p}    \\ 
                            &\equiv -1                                  &&\pmod{p}    \\
                    \end{MultiLineEquation*}
        ...
        \subsection{Congruencias Lineales}
            ...
            \subsubsection{¿Cuántas Soluciones incongruentes existen?}
                ...
                \begin{SmallIndentation}[1em]
                    ...
                    Recuerda que nuestra congruencia $ax \equiv b \pmod{n}$ puede
                    ser expresada como una ecuación diofantina: $ax - ny = b$.

                    Recuerda que si $x_0, y_0$ es \textbf{una} solución a la
                    ecuación $ax+ by = c$, donde $t \in \Integers$ y $d=GCD(a,b)$
                    ...
                    Por lo tanto podemos tomar un una solución para nuestra ecuación
                    diofantica como:
                    \begin{MultiLineEquation*}{3}
                        x = x_0 + \dfrac{n}{d}t
                        \Space\Space
                    ...
                    Recueda que nos importa $x$ por lo tanto podemos ver $x = x_0 + \dfrac{n}{d}t$
                    como $x \equiv x_0 \pmod{\dfrac{n}{d}}$

                    Por lo tanto para obtener todas las soluciones que son incongruentes entre
                    ellas podemos hacer variar nuestra $t$ de tal manera que que forme un 
                    sistema completo de residuos, es decir, $t \in \Set{ 0, 1, 2, \dots, d-1}$.
                    Por lo mismo podemos decir que tenemos $d$ soluciones diferentes.

                \end{SmallIndentation}


                De aquí podemos rescatar que si $GCD(a, n) = 1$, es decir \textbf{si $a$ y $n$
                son} primos relativos entonces tendremos una \textbf{única solución}.
        ...
        \begin{itemize}
            ...
            \item Sea $p$ un número primo, entonces habrá exactamente $\frac{p^2-p}{2}$ polinomios
                ...
                \begin{SmallIndentation}[1em]
                    ...
                    Por lo tanto:
                    \begin{MultiLineEquation*}{3}
                        p^2 - \Wrap{\frac{p(p-1)}{2} + p}               
                            &= p^2 - \Wrap{\frac{p(p-1)}{2} + p}        \\
                            &= p^2 - \Wrap{\frac{p(p-1) + 2p}{2}}       \\
                            &= p^2 - \Wrap{\frac{p^2 - p + 2p}{2}}      \\
                            &= p^2 - \Wrap{\frac{p^2 + p}{2}}           \\
                            &= \Wrap{\frac{p^2 - p}{2}}
                    \end{MultiLineEquation*}
...
\begin{thebibliography}{10}
    ...
    \bibitem{LeonardoFaustinosMorales} 
