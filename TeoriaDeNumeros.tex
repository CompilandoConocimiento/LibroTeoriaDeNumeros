...
\chapter{Congruencias}
    ...
    % =====================================================
    \clearpage
    \section{Congruencias de Grado Uno}
    ...
    \section{Teorema Chino del Residuo}
        ...
        Si $m_1, \dots, m_r$ son enteros positivos primos relativos entre si, y $a_1, \dots, a_r$
        son enteros cuales quiera, entonces el sistema de congruencias:
        \begin{MultiLineEquation*}{3}
