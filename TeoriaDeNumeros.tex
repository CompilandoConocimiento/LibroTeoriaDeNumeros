    ...
    \section{Divisibilidad}
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        \begin{itemize}
                            ...
                            \item $3 | (k)(k+1)(k+2)(k+3)(k+4)\dots(k+n)$
                                Pues mínimo alguno de los términos de la suseción será divisible entre 3, pues hay mas de
                                3 enteros consecutivos
                            \item $4 | (k)(k+1)(k+2)(k+3)(k+4)\dots(k+n)$
                                Pues mínimo alguno de los términos de la suseción será divisible entre 4, pues hay mas de
                                4 enteros consecutivos
                            \item ...
                        \end{itemize}
        ...
        \subsection{Resultados ó Cosas Cool}
            ...
            \begin{itemize}
                ...
                \item Dado un conjunto de $k$ enteros arbitrarios (donde $k \in \Naturals$ y $k > 1$ )
            ...
            \begin{itemize}
                ...
                \item Si $a|m$ y $b|m$ entonces $LCM(a,b)|m$
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        si no lo fuera tendríamos que $m = q \cot LCM(a,b) + r$
                        donde $0<r<LCM(a,b)$
